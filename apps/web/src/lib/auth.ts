...
const APP_ERROR_HTTP_STATUS = {
  ...
  AI_STORY_EXECUTION_DENIED: 403,
  COMMERCIAL_AUTH_BILLING_MISSING: 403,
  COMMERCIAL_AUTH_SUBSCRIPTION_INVALID: 403,
  COMMERCIAL_AUTH_ENTITLEMENT_DENIED: 403,
  COMMERCIAL_AUTH_CREDITS_INSUFFICIENT: 403,
  DATABASE_DEPENDENCY_TIMEOUT: 503,
  EXECUTION_PLAN_OWNERSHIP_INVALID: 403,
  CAMPAIGN_ASSET_REF_MISSING: 409,
  CAMPAIGN_ASSET_REF_DENIED: 403,
  CAMPAIGN_ASSET_REF_PERSIST_FAILED: 409,
  NO_EXECUTABLE_PROVIDER: 409,
  ...
  REVISION_SOURCE_VERSION_CONFLICT: 409,
  REVISION_SCOPE_DENIED: 403,
} as const;
