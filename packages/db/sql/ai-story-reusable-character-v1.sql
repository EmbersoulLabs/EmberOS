...
CREATE TABLE IF NOT EXISTS ai_story_reusable_character_versions (
  ...
  reusable_character_id uuid NOT NULL REFERENCES ai_story_reusable_characters(reusable_character_id) ON DELETE RESTRICT,
  org_id uuid NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
  workspace_id uuid NOT NULL REFERENCES workspaces(id) ON DELETE RESTRICT,
  ...
  status text NOT NULL CHECK (status IN ('ACTIVE','ARCHIVED','DELETED')),
  supersedes_reusable_character_version_id uuid REFERENCES ai_story_reusable_character_versions(reusable_character_version_id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS ai_story_reusable_character_campaign_projections (
  ...
  workspace_id uuid NOT NULL REFERENCES workspaces(id) ON DELETE RESTRICT,
  reusable_character_id uuid NOT NULL REFERENCES ai_story_reusable_characters(reusable_character_id) ON DELETE RESTRICT,
  reusable_character_version_id uuid NOT NULL REFERENCES ai_story_reusable_character_versions(reusable_character_version_id) ON DELETE RESTRICT,
  reusable_character_fingerprint text NOT NULL,
  campaign_id uuid NOT NULL REFERENCES campaigns(id) ON DELETE RESTRICT,
  campaign_character_id uuid NOT NULL REFERENCES ai_story_characters(character_id) ON DELETE RESTRICT,
  campaign_character_version_id uuid NOT NULL REFERENCES ai_story_character_versions(character_version_id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS ai_story_character_continuity_anchors (
  ...
  reusable_character_id uuid NOT NULL REFERENCES ai_story_reusable_characters(reusable_character_id) ON DELETE RESTRICT,
  reusable_character_version_id uuid NOT NULL REFERENCES ai_story_reusable_character_versions(reusable_character_version_id) ON DELETE RESTRICT,
  source_episode_id uuid NOT NULL REFERENCES ai_stories(id) ON DELETE RESTRICT,
