...
await apply("ai-story-generated-scene-review-v1.sql");
await apply("ai-story-generated-scene-review-rls-v1.sql");
console.log("AI Story generated Scene review schema applied.");
