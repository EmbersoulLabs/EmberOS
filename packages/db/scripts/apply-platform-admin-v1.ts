/**
 * Apply Sprint 4 Phase B2 Platform Administration SQL + RLS.
 *
 * Usage:
 *   pnpm --filter @ceo-agent/db exec tsx scripts/apply-platform-admin-v1.ts
 */
...
async function main() {
  ...
  try {
    for (const relative of [
      "../sql/platform-admin-v1.sql",
      "../sql/platform-admin-rls-v1.sql",
    ]) {
