...
await apply("ai-story-assembly-runtime-artifact-v1.sql");
await apply("ai-story-assembly-runtime-rls-v1.sql");
console.log("AI Story Assembly Runtime artifact metadata + RLS schema applied.");
