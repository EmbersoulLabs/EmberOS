/**
 * Apply Sprint 4 Phase D Credits & Settlement SQL + RLS.
 *
 * Usage:
 *   pnpm --filter @ceo-agent/db exec tsx scripts/apply-credits-settlement-v1.ts
 */
...
async function main() {
  ...
  try {
    for (const relative of [
      "../sql/credits-settlement-v1.sql",
      "../sql/credits-settlement-rls-v1.sql",
    ]) {
