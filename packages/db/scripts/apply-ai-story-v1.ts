/**
 * Apply Campaign-owned AI Story tables (V1 vertical slice).
 * Usage: pnpm --filter @ceo-agent/db sql:ai-story
 */
...
const sqlFile = resolve(__dirname, "../sql/ai-story-v1.sql");
...
try {
  ...
  console.log("AI Story schema applied.");
} finally {
  await db.end();
}
