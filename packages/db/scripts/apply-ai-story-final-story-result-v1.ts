...
await apply("ai-story-final-story-result-v1.sql");
await apply("ai-story-final-story-result-rls-v1.sql");
console.log("AI Story Final Story Result persistence + RLS schema applied.");
