...
export const AI_STORY_EPISODE_REVISION_AUTHORITY = "CERTIFIED" as const;
export const EDIT_DIALOGUE = "CERTIFIED" as const;
export const DIALOGUE_SMALLEST_SCOPE_INVALIDATION = "CERTIFIED" as const;
export const ADJUST_ENDING = "CERTIFIED" as const;
export const ADJUST_PACING = "CERTIFIED" as const;
export const REPLACE_REFERENCE = "CERTIFIED" as const;
...
export const EPISODE_FIRST_UI_REVISION = "PRESENTATION_AND_REVISION_CERTIFIED" as const;
export const AI_STORY_EPISODE_REVISION_PERSISTENCE = "CONTRACT_LAYER_ONLY" as const;
...
export const AiStoryEpisodeRevisionCapabilitySchema = z
  .object({
    ...
    persistDurableScript: z.literal(false),
...
export function revisionActionEnabled(
  ...
  return capability.availableRevisionTypes.includes(type);
}
