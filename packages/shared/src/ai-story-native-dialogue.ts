...
export const SEEDANCE_NATIVE_AUDIO_CAPABILITY =
  "TECHNICAL_PASS_HUMAN_REVIEW_REQUIRED" as const;
...
export const NATIVE_AV_REQUEST_CONTRACT = "CERTIFIED" as const;
export const NATIVE_AUDIO_RESULT_VALIDATION = "CERTIFIED" as const;
export const SG_MY_LOCALE_REQUEST_AUTHORITY = "CERTIFIED" as const;
...
export const CHARACTER_DIALOGUE_PERFORMANCE_GATE =
  "HUMAN_REVIEW_REQUIRED" as const;
export const VISIBLE_DIALOGUE_DETACHED_TTS_CONFLICT_PROTECTION =
  "CERTIFIED" as const;
export const SEEDANCE_V1_AUDIO_SILENCE_COMPATIBILITY = "CERTIFIED" as const;
export const SEEDANCE_NATIVE_AUDIO_REAL_PROVIDER_EXECUTION =
  "CERTIFIED" as const;
export const SEEDANCE_NATIVE_DIALOGUE_REAL_PROVIDER_EXECUTION =
  "CERTIFIED" as const;
export const HUMAN_DIALOGUE_PERFORMANCE = "PENDING_HUMAN_REVIEW" as const;
export const LIP_SYNC = "PENDING_HUMAN_REVIEW" as const;
export const MALAYSIAN_CHINESE_NATURALNESS = "PENDING_HUMAN_REVIEW" as const;
export const TAPAO_JOM_EPISODE = "NOT_RUN_IN_THIS_TICKET" as const;
export const SEEDANCE_NATIVE_DIALOGUE_CERTIFICATION_EXACT_TEXT =
  "Eh，这个看起来真的不错。" as const;
export const SEEDANCE_NATIVE_DIALOGUE_CERTIFICATION_PRIMARY_LOCALE =
  "zh-MY" as const;
export const SEEDANCE_NATIVE_DIALOGUE_CERTIFICATION_SECONDARY_LOCALE =
  "en-MY" as const;
